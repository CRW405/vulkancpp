...
Device::Device(Window &window) : window{ window } {
	...
	setupDebugMessenger(); // setup debug messenger for validation layers
	createSurface();       // create window surface for rendering, connects Vulkan to the glfw
	pickPhysicalDevice();  // pick a physical device (GPU) that supports Vulkan
